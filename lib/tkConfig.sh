...
# installed.
TK_PREFIX='/Users/rachelzhang/opt/anaconda3/envs/word_memorizer'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/rachelzhang/opt/anaconda3/envs/word_memorizer'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/rachelzhang/opt/anaconda3/envs/word_memorizer/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/rachelzhang/opt/anaconda3/envs/word_memorizer/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/rachelzhang/opt/anaconda3/envs/word_memorizer/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/rachelzhang/opt/anaconda3/envs/word_memorizer/lib/libtkstub8.6.a'
